...
<body style="background-color:cadetblue">
    ...
    <div class="container mt-3">
        <div class="card text-white bg-secondary mb-3 mx-auto" style="max-width:619px;">
            ...
            <div class="card-body">
                <form name="f1" action="action2.php" method='POST'>
                    ...
                    <div class="input-group form-group mt-3">
                        ...
                        if (!isset($_COOKIE['pass'])) {
                            echo "<input type='password' class='form-control' placeholder='contraseña' name='pass' required />";
                        } else {
                            echo "<input type='password' class='form-control' value='{$_COOKIE['pass']}' name='pass' required />";
                        }
                        ?>
                        ...
                        <div class='col'>
                            <div class='form-group form-check text-nowrap'>
                                ...
                                if(isset($_COOKIE['error']) && $_COOKIE['error'] == 3) {
                                    echo "<input type='submit' value='Login' class='btn btn-primary float-right' disabled='true' />";
                                }else {
                                    echo "<input type='submit' value='Login' class='btn btn-primary float-right' />";
                                }
                                ?>
