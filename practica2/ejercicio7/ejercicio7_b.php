...
<head>
    ...
    <title>Ejercicio 7_b</title>
</head>

<body>
    <h3 class="mt-3 text-center">Ejercicio 7_b</h3>
    <div class="container mt-3">
        ...
        ?>
            <form name="form7" action="<?php echo $_SERVER['PHP_SELF']; ?>" method='POST' enctype="multipart/form-data">
                <div class="row">
                    <div class='col'>
