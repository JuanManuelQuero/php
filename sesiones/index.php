...
<body style="background-color:cadetblue">
    <div class="container mt-5">
        ...
        if (isset($_POST["login"])) {
            ...
            if ($comprobar[0]) {
                //Validacion correcta, me creo las variables de sesion(usu y perfil)
                $_SESSION["usuario"] = $usuario;
                $_SESSION["perfil"] = $comprobar[1];
                header("Location:sitio.php");
            } else {
                //me he equivocado, montamos el error
                //me creo una variable de sesion con el mensaje de error
                        ...
                        <div class='row mt-3'>
                            <div class='col'>
                                <div class='form-group form-check text-nowrap'>
                                    ...
                                    <button type='submit' class='btn btn-dark float-right ml-3' name='invitado'><i class="fas fa-user-friends mr-2"></i>Invitado</button>
