...
<body style="background-color: darkSalmon">
  ...
  <div class="container">
    ...
    ?>
    <a href="cautor.php" class="btn btn-success my-2"><i class="fas fa-user-plus mr-2"></i>Autores</a>
        ...
        while ($fila = $todos->fetch(PDO::FETCH_OBJ)) {
          echo <<<TXT
            <tr>
              ...
              <a href="detalleAutor.php?id={$fila->id_autor}" class="btn btn-info mr-2"><i class="fas fa-user-check mr-2"></i>Detalle</a>
